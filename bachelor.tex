...
reasonably implemented with a variant of lazy streams: file handling.
...
The C programming language is from 1973\footnote{Beleg? K+R?} and lacking some
modern features. The C type system essentially only knows about numbers:
pointers are a special case of numbers and strings are also represented as
arrays of numbers.
...
automatically, which creates the iterator on its own, as in
