...
it must be a
duck}~\cite{lutz2013learning}\cite[p.~89]{olsen2011eloquent}\cite[p.~51]{clinton2009ruby}.
...
\begin{itemize}
  ...
  \item Throw a \inline{StopIteration} exception after the last element was
	  ...
	  will not provide any more values~\cite{lutz2013learning}.
...
interface~\cite{lutz2013learning}. This iterable can be the object itself, as
shown in the code listings.
...
\begin{listing}[H]
  ...
  \caption{An iterable in Python~\cite{lutz2013learning}}
...
generator~\cite{lutz2013learning}. \autoref{lst:pygenerator} demonstrates a
