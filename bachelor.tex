...
constructed and is a lot simpler.

% TODO add compress
\begin{minted}[linenos]{ocaml}
val decompress: string -> ost_entry list ErrorMonad.t
val (|>): ErrorMonad.t -> (t -> ErrorMonad.d) -> ErrorMonad.t
\end{minted}
...
\begin{itemize}
  ...
  \item libarchive, a version newer than 3.1.2, e.g. the development version
	  including commit \texttt{59cf95f5d9}. Development packages (if any)
