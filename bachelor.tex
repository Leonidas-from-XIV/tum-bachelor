...
\begin{minted}[linenos]{ocaml}
type read_filter =
  | AllFilterReader        | LRZipFilterReader      | RPMFilterReader
  | BZip2FilterReader      | LZipFilterReader       | UUFilterReader
  | CompressFilterReader   | LZMAFilterReader       | XZFilterReader
  | GRZipFilterReader      | LZOPFilterReader
  | GZipFilterReader       | NoneFilterReader
\end{minted}
